const page = () => {
  return (
    ...
    <div className="relative z-10 min-h-screen flex flex-col justify-center items-center px-4 md:px-8 lg:px-16">
      <div className="text-center">
        ...
        <p className="text-lg text-balance md:max-w-[60%] mx-auto mt-6">
          You can contact us by phone, email, or by filling out the form
      ...
      <div className="mt-8 w-full max-w-md mx-auto">
        <form action="" className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          ...
          <div className="text-center">
            <button type="submit" className="bg-restaurant-primary hover:bg-primary-dark text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Submit</button>
          </div>
        </form>
      </div>
    </div>
